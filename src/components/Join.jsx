        ...
        <div className="relative container mx-auto">
          <div className="grid gap-[30px] lg:grid-cols-2 m-5 items-center">
            ...
            <h1 className="text- text-base sm:text-2xl md:text-2xl lg:text-2.5xl p-2 sm:p-4 lg:p-5 md:p-10">
              ...
              broaden their understanding of emerging technologies and shape
              their skills into a better version. The club intends to provide
              students with hands-on technology through Google's curated
              resources.
            </h1>
          </div>
